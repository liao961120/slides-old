...
.left-column[
### 内容 <a href='' style='font-size: 0.35em;'> GitHub</a>
]
...
before_install:   # 安装 R 包以外 dependencies
  - sudo apt-get update
  - tlmgr install index  # 安装 latex 包
...
* .smaller[.red[Current working directory on Travis]: GitHub repo]
...
.right-column[
push commit to GitHub or Trigger build on Travis ➜  
wait for build ➜ Web site at
